...
NAV = """      <nav class="flex items-center justify-between h-20" aria-label="Principale">
        ...
        <ul class="hidden xl:flex items-center gap-5 text-sm font-medium">
          <li><a href="index.html#services" class="nav-link">Services</a></li>
          <li><a href="developpement-web.html" class="nav-link">Web &amp; mobile</a></li>
          <li><a href="infrastructure-cybersecurite.html" class="nav-link">Infra &amp; sécu</a></li>
          <li><a href="zones-intervention.html" class="nav-link">Zones</a></li>
        ...
        <div class="flex items-center gap-4">
          ...
          <button id="menu-toggle" class="xl:hidden p-2 text-white" type="button" aria-label="Menu" aria-expanded="false" aria-controls="mobile-menu">
            <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 6h16M4 12h16M4 18h16"/></svg>
          </button>
        </div>
      </nav>
      <div id="mobile-menu" class="hidden xl:hidden pb-6 pt-2 space-y-2 border-t border-white/5">
        <a href="index.html#services" class="mobile-link">Services</a>
        <a href="developpement-web.html" class="mobile-link">Web &amp; mobile</a>
        <a href="infrastructure-cybersecurite.html" class="mobile-link">Infra &amp; sécu</a>
        <a href="zones-intervention.html" class="mobile-link">Zones d’intervention</a>
